...
function cart(){
		...
		if (isset($_GET['pro_id'])) {
			// $sel_price = "SELECT customer_id from customers WHERE customer_email = '$email'";
		...
		$run_check = mysqli_query($con,$check_pro);
			if (!$p_id) {
				$insert_pro = "insert into cart(p_id,ip_add,qty,customer_id) values('$pro_id','$ip',1,'$cus_id') ";
